...
class Converter:
    def __init__(self):
        ...
        self.all_calc_list = ['5 degrees C is -17.8 degrees F',
                              '6 degrees C is 32 degrees F',
                              '7 degrees C is 75.2 degrees F',
                              '8 degrees C is 37.8 degrees F'
                              '9 degrees C is 37.8 degrees F']
        ...
        # Help Button (row 1)
        self.history_button = Button(self.converter_frame, text="Click Me",
                                     font=("Arial", "14"),
                                     padx=10, pady=10,
